...
#def GetOffsetFromClusterData(rootcluster, cluster):
#        if (debug == 1):
#        print ('Entering GetOffsetFromClusterData:')
#    return ''
...
def CheckFileLength(file):
    #Check if the file length is too short
